...
public class RunSmallSupermarket {
    public static void main(String[] args) {
        ...
        supermarket.supermkName = "Advantest超市";
        ...
        while (open)
        {
            System.out.println("本店叫做"+supermarket.supermkName);
            System.out.println("本店地址"+supermarket.address);
            System.out.println("停车位有"+supermarket.parkingCount);
            System.out.println("今天营业额为"+supermarket.incomingSum);
            System.out.println("全部商品有"+supermarket.merchandises.length+"种");
            ...
            if (customer.isDrivingCar) {
                if (supermarket.parkingCount > 0) {
                    System.out.println("欢迎" + customer.name + "驾车而来。本店已经为您安排了车位，停车免费哦。车位编号为" + supermarket.parkingCount);
        ...
        System.out.println("今天总的营业额为" + supermarket.incomingSum + "。营业情况如下");
